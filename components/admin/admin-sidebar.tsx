...
const NAV: ReadonlyArray<NavItem> = [
  ...
  { href: "/admin/clients" as Route,     label: "Clients",     icon: Contact },
  ...
  { href: "/admin/salary-profiles" as Route, label: "Salary Profiles", icon: Briefcase },
  { href: "/admin/paying-entities" as Route, label: "Paying Entities", icon: Landmark },
  { href: "/admin/outstanding-products" as Route,     label: "Receivable Products", icon: Package },
  { href: "/admin/outstanding-entities" as Route,     label: "Billing Entities",    icon: Store },
  { href: "/admin/outstanding-payment-modes" as Route, label: "Payment Modes",      icon: CreditCard },
  { href: "/admin/outstanding-responsibles" as Route,  label: "Collection Owners",  icon: UserCog },
    ...
    >
      ...
      <div className="relative flex flex-col h-full overflow-hidden">
        ...
        <div className="px-6 pt-8 pb-6 shrink-0">
          ...
          <p className="text-[12.5px] mt-3 text-white/60">Ehara Engineering</p>
        </div>
